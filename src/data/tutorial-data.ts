...
export const fetchTutorialData = (tutorialUrlParam: string) => {
	const tutorials: Record<string, unknown> = {
		...
		"cornrow-main": CornrowMainData,
		"cornrow-loops": CornrowLoopsData,
		"cornrow-parameters": CornrowParamsData,
		"cornrow-functions": CornrowFunctionsData,
		"cornrow-variables": CornrowVarsData,
		"cornrow-conditionals": CornrowConditionalsData,
