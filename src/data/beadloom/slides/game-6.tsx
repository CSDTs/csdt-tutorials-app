...
export const BeadLoomMathGame6 = () => {
	const imageUrlCurrent = getAssetContent("beadloom/math/math-6a.png");
	const imageUrlCorrect = getAssetContent("beadloom/math/math-6b.png");
	...
	return (
		<div>
			<p>
				Amber found a bead pattern with a face on it, but wants to get a black bead in the nose position. Find the
				y-value for the nose!
			</p>
			<img src={imageUrlCurrent} alt="Game 6" hidden={isCorrect} className="max-w-lg" />
			<img src={imageUrlCorrect} alt="Game 6" hidden={!isCorrect} className="max-w-lg" />
