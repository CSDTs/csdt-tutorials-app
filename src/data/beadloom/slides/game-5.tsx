...
export const BeadLoomMathGame5 = () => {
	const imageUrlCurrent = getAssetContent("beadloom/math/math-5a.png");
	const imageUrlCorrect = getAssetContent("beadloom/math/math-5b.png");
	...
	return (
		<div>
			<p>
				Keifen picked up a cool design and wants to fill in the missing space with a green bead. Enter the x-value of
				the location where the green bead should go.
			</p>
			<img src={imageUrlCurrent} alt="Game 5" hidden={isCorrect} className="max-w-lg" />
			<img src={imageUrlCorrect} alt="Game 5" hidden={!isCorrect} className="max-w-lg" />
